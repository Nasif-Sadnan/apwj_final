...
public class ProductRepository {
    ...
    public Product getById(int id) {
        return jdbcTemplate.queryForObject("SELECT * FROM products WHERE id = ?", new Object[]{id}, new BeanPropertyRowMapper<>(Product.class));
    }

    public void save(Product product) {
        jdbcTemplate.update("INSERT INTO products (name, category_id, price, quantity, expiry_date, is_available) VALUES (?, ?, ?, ?, ?, ?)",
    ...
    public void update(Product product) {
        jdbcTemplate.update("UPDATE products SET name = ?, category_id = ?, price = ?, quantity = ?, expiry_date = ?, is_available = ? WHERE id = ?",
    ...
    public List<Product> getLowStock(int threshold) {
        return jdbcTemplate.query("SELECT * FROM products WHERE quantity < ?", new Object[]{threshold}, new BeanPropertyRowMapper<>(Product.class));
    }
}
